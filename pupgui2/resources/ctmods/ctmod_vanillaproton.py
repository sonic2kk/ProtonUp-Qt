...
import os, shutil, tarfile, requests, hashlib, re
from PySide6.QtCore import *

CT_NAME = 'Proton'
CT_LAUNCHERS = ['steam', 'heroicproton', 'bottles']
CT_DESCRIPTION = {}
CT_DESCRIPTION['en'] = '''Compatibility tool for Steam Play based on Wine and additional components.'''


class CtInstaller(QObject):

    BUFFER_SIZE = 65536
    CT_URL = 'https://api.github.com/repos/ValveSoftware/proton/releases'
    CT_INFO_URL = 'https://github.com/ValveSoftware/proton/releases/tag/'
    ...
    def fetch_releases(self, count=100):
        ...
        return re.findall(r'(proton\-[0-9]\.[0-9]+\-[0-9]+)', ''.join(tags))
