...
APP_THEMES: tuple[str, str, str, None] = ( 'light', 'dark', 'system', None )
...
TEMP_DIR: str = os.path.join(os.getenv('XDG_CACHE_HOME', ''), 'tmp', 'pupgui2.a70200/') if os.path.exists(os.getenv('XDG_CACHE_HOME', '')) else '/tmp/pupgui2.a70200/'
...
_POSSIBLE_STEAM_ROOTS: list[str] = [
...
POSSIBLE_INSTALL_LOCATIONS: list[dict[str, str]] = [
        {
...
PROTONDB_COLORS: dict[str, str] = {'platinum': '#b4c7dc', 'gold': '#cfb53b', 'silver': '#a6a6a6', 'bronze': '#cd7f32', 'borked': '#ff0000', 'pending': '#748472' }
